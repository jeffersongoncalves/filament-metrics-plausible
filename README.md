...
![Filament Metrics Plausible](https://raw.githubusercontent.com/jeffersongoncalves/filament-metrics-plausible/3.x/art/jeffersongoncalves-filament-metrics-plausible.png)
...
[![Tests](https://img.shields.io/github/actions/workflow/status/jeffersongoncalves/filament-metrics-plausible/tests.yml?branch=3.x&label=tests&style=flat-square)](https://github.com/jeffersongoncalves/filament-metrics-plausible/actions?query=workflow%3ATests+branch%3A3.x)
